...
# День 32
d32 = Day.create(id:32)
d32.date = '30.08.2013'.to_date
d32.comment = 
	"Закрытие сезона. Поиграли под дождиком и поехали во Fridayes в МДМ.
	Посидели, посмотрели суперкубок УЕФА."
games = [
	[1, 'Спаич'			, 'Прас'		, 'Нечипур'	, 'Тёма'		, 16, 14 	],
	[2, 'Спаич'			, 'Прас'		, 'Нечипур'	, 'Олег'		, 16, 14 	],
	[3, 'Спаич'			, 'Прас'		, 'Тёма'	, 'Олег'		, 15, 10 	],
	[4, 'Спаич'			, 'Прас'		, 'Тёма'	, 'Нечипур'		, 15, 8 	],
	[5, 'Спаич'			, 'Прас'		, 'Саня'	, 'Олег'		, 15, 6 	],
	[6, 'Саня'			, 'Тёма'		, 'Спаич'	, 'Прас'		, 15, 9 	],
	[7, 'Саня'			, 'Тёма'		, 'Спаич'	, 'Олег'		, 15, 10 	],
	[8, 'Саня'			, 'Тёма'		, 'Прас'	, 'Олег'		, 15, 12 	],
	[9, 'Саня'			, 'Тёма'		, 'Спаич'	, 'Олег'		, 15, 12 	],
	[10,'Саня'			, 'Тёма'		, 'Спаич'	, 'Олег'		, 15, 10 	]
]
games.each { |game| create_game_in_day_by_array(d32, game) }
d32.save